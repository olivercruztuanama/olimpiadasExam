    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/Contenido/css").Include(
                      "~/Contenido/bootstrap.min.css",
                      "~/Contenido/animate.css",
                      "~/Contenido/style.css?v=1"));
            ...
            bundles.Add(new StyleBundle("~/Contenido/plugins/blueimp/css/").Include(
                      "~/Contenido/plugins/blueimp/css/blueimp-gallery.min.css"));
            ...
            bundles.Add(new StyleBundle("~/plugins/morrisStyles").Include(
                      "~/Contenido/plugins/morris/morris-0.4.3.min.css"));
            ...
            // iCheck css styles
            bundles.Add(new StyleBundle("~/Contenido/plugins/iCheck/iCheckStyles").Include(
                      "~/Contenido/plugins/iCheck/custom.css"));
            ...
            bundles.Add(new StyleBundle("~/Contenido/plugins/dataTables/dataTablesStyles").Include(
                      "~/Contenido/plugins/dataTables/datatables.min.css", "~/Contenido/plugins/dataTables/dataTables.dateTime.min.css"));
            ...
            // jqGrid styles
            bundles.Add(new StyleBundle("~/Contenido/plugins/jqGrid/jqGridStyles").Include(
                      "~/Contenido/plugins/jqGrid/ui.jqgrid.css"));
            ...
            bundles.Add(new StyleBundle("~/plugins/codeEditorStyles").Include(
                      "~/Contenido/plugins/codemirror/codemirror.css",
                      "~/Contenido/plugins/codemirror/ambiance.css"));
            ...
            bundles.Add(new StyleBundle("~/plugins/fullCalendarStyles").Include(
                      "~/Contenido/plugins/fullcalendar/fullcalendar.css"));
            ...
            // ionRange styles
            bundles.Add(new StyleBundle("~/Contenido/plugins/ionRangeSlider/ionRangeStyles").Include(
                      "~/Contenido/plugins/ionRangeSlider/ion.rangeSlider.css",
                      "~/Contenido/plugins/ionRangeSlider/ion.rangeSlider.skinFlat.css"));
            ...
            bundles.Add(new StyleBundle("~/plugins/dataPickerStyles").Include(
                      "~/Contenido/plugins/datapicker/datepicker3.css"));
            ...
            bundles.Add(new StyleBundle("~/plugins/nouiSliderStyles").Include(
                      "~/Contenido/plugins/nouslider/jquery.nouislider.css"));
            ...
            bundles.Add(new StyleBundle("~/plugins/jasnyBootstrapStyles").Include(
                      "~/Contenido/plugins/jasny/jasny-bootstrap.min.css"));
            ...
            bundles.Add(new StyleBundle("~/plugins/switcheryStyles").Include(
                      "~/Contenido/plugins/switchery/switchery.css"));
            ...
            // chosen styles
            bundles.Add(new StyleBundle("~/Contenido/plugins/chosen/chosenStyles").Include(
                      "~/Contenido/plugins/chosen/bootstrap-chosen.css"));
            ...
            bundles.Add(new StyleBundle("~/plugins/wizardStepsStyles").Include(
                      "~/Contenido/plugins/steps/jquery.steps.css"));
            ...
            // dropZone styles
            bundles.Add(new StyleBundle("~/Contenido/plugins/dropzone/dropZoneStyles").Include(
                      "~/Contenido/plugins/dropzone/basic.css",
                      "~/Contenido/plugins/dropzone/dropzone.css"));
            ...
            bundles.Add(new StyleBundle("~/plugins/summernoteStyles").Include(
                      "~/Contenido/plugins/summernote/summernote.css",
                      "~/Contenido/plugins/summernote/summernote-bs3.css"));
            ...
            bundles.Add(new StyleBundle("~/plugins/toastrStyles").Include(
                      "~/Contenido/plugins/toastr/toastr.min.css"));
            ...
            // color picker styles
            bundles.Add(new StyleBundle("~/Contenido/plugins/colorpicker/colorpickerStyles").Include(
                      "~/Contenido/plugins/colorpicker/bootstrap-colorpicker.min.css"));
            ...
            bundles.Add(new StyleBundle("~/plugins/imagecropperStyles").Include(
                      "~/Contenido/plugins/cropper/cropper.min.css"));
            ...
            // jsTree styles
            bundles.Add(new StyleBundle("~/Contenido/plugins/jsTree").Include(
                      "~/Contenido/plugins/jsTree/style.css"));
            ...
            bundles.Add(new ScriptBundle("~/plugins/tinycon").Include(
                      "~/Scripts/plugins/tinycon/tinycon.min.js?v=1"));

            // Chartist
            bundles.Add(new StyleBundle("~/plugins/chartistStyles").Include(
                      "~/Contenido/plugins/chartist/chartist.min.css"));
            ...
            bundles.Add(new StyleBundle("~/plugins/awesomeCheckboxStyles").Include(
                      "~/Contenido/plugins/awesome-bootstrap-checkbox/awesome-bootstrap-checkbox.css"));

            // Clockpicker styles
            bundles.Add(new StyleBundle("~/plugins/clockpickerStyles").Include(
                      "~/Contenido/plugins/clockpicker/clockpicker.css"));
            ...
            bundles.Add(new StyleBundle("~/plugins/dateRangeStyles").Include(
                      "~/Contenido/plugins/daterangepicker/daterangepicker-bs3.css"));
            ...
            bundles.Add(new StyleBundle("~/plugins/sweetAlertStyles").Include(
                      "~/Contenido/plugins/sweetalert/sweetalert.css"));
            ...
            bundles.Add(new StyleBundle("~/plugins/footableStyles").Include(
                      "~/Contenido/plugins/footable/footable.core.css", new CssRewriteUrlTransform()));
            ...
            bundles.Add(new StyleBundle("~/plugins/select2Styles").Include(
                      "~/Contenido/plugins/select2/select2.min.css"));
            ...
            bundles.Add(new StyleBundle("~/plugins/slickStyles").Include(
                      "~/Contenido/plugins/slick/slick.css", new CssRewriteUrlTransform()));

            // Slick carousel theme Styless
            bundles.Add(new StyleBundle("~/plugins/slickThemeStyles").Include(
                      "~/Contenido/plugins/slick/slick-theme.css", new CssRewriteUrlTransform()));
            ...
            bundles.Add(new StyleBundle("~/plugins/laddaStyles").Include(
                      "~/Contenido/plugins/ladda/ladda-themeless.min.css"));
            ...
            bundles.Add(new StyleBundle("~/plugins/touchSpinStyles").Include(
                      "~/Contenido/plugins/touchspin/jquery.bootstrap-touchspin.min.css"));
            ...
            bundles.Add(new StyleBundle("~/plugins/tourStyles").Include(
                      "~/Contenido/plugins/bootstrapTour/bootstrap-tour.min.css"));
            ...
            bundles.Add(new StyleBundle("~/plugins/c3Styles").Include(
                      "~/Contenido/plugins/c3/c3.min.css"));
            ...
            bundles.Add(new StyleBundle("~/plugins/markdownStyles").Include(
                      "~/Contenido/plugins/bootstrap-markdown/bootstrap-markdown.min.css"));
            ...
            bundles.Add(new StyleBundle("~/plugins/tagInputsStyles").Include(
                      "~/Contenido/plugins/bootstrap-tagsinput/bootstrap-tagsinput.css"));
            ...
            bundles.Add(new StyleBundle("~/plugins/socialButtonsStyles").Include(
                      "~/Contenido/plugins/bootstrapSocial/bootstrap-social.css"));
            ...
            bundles.Add(new StyleBundle("~/plugins/textSpinnersStyles").Include(
                      "~/Contenido/plugins/textSpinners/spinners.css"));
            ...
            // Signature Style
            bundles.Add(new StyleBundle("~/Contenido/plugins/signature/signatureStyles").Include(
                      "~/Contenido/plugins/signature/jquery.signaturepad.css"));

            // Signature
            bundles.Add(new ScriptBundle("~/plugins/signature").Include(
                        //"~/Scripts/plugins/signature/jquery.signaturepad.min.js",
                        "~/Scripts/plugins/signature/signature_pad.js"/*,
                        "~/Scripts/plugins/signature/jquery.signaturepad.js",
                        "~/Scripts/plugins/signature/jquery.ui.touch-punch.js"*/));
        }
    }
}
